...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params) {
	    ...
	    if(params.get("sign") != null) {
	    	...
	    	System.out.println("alipayalipayalipayalipay sign is="+sign);
	    }else {
	    	System.out.println("alipayalipayalipayalipay=  sign is null");
	    }
	    boolean isSign = getRSASignVerify(params, sign);

        //写日志记录（若要调试，请取消下面两行注释）
        String sWord = "responseTxt=" + responseTxt + "\n isSign=" + isSign + "\n feddbackParemater：" + AlipayCore.createLinkString(params);
